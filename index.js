...
//console.log(slugify('Hello World',{replacement:'-',lower:true}));  // example of slugify module
  const slugs = dataObj.map(el => (slugify(el.productName,{replacement:'-',lower:true})));
  console.log(slugs);
